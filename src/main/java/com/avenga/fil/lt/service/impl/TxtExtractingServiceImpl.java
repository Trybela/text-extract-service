...
public class TxtExtractingServiceImpl implements TxtExtractingService {
    ...
    @Override
    public List<String> extractTextFromTxt(RequestPayloadData data) {
        try (final var s3Object = s3Client.getObject(GetObjectRequest.builder().bucket(data.getBucketName()).key(data.getFileKey()).build());
